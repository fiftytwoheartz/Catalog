...
namespace Catalog.WebApi.Controllers {
    ...
    public class MetaCategoriesController : ApiController {
        ...
        private static HintIntermediate ProductsOfMetaCategoryHint(
            int id) {
            return new HintIntermediate(
                true,
                false,
                HttpVerb.GET,
                "See all the products associated with this meta-category.",
                $"api/metacategories/{id}/products");
        }

        public async Task<JsonResult<Response>> Post(
            [FromBody] MetaCategory metaCategory) {
            return Json(
        ...
        public async Task<JsonResult<Response>> Delete(
            int id) {
